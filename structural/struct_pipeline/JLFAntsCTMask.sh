...
subjects=/data/joy/BBL/studies/grmpy/processedData/structural/struct_pipeline_20170821/*

for s in $subjects; do ./JLFAndCTGMMask.sh ${s}/*/jlf/*_Labels.nii.gz ${s}/*/antsCT/*_BrainSegmentation.nii.gz ${s}/*/jlf/ ; done
