...
data <- read.csv('/data/joy/BBL/projects/grmpyProcessing2017/structural/OutputROI/JLFvol/ctVolValues_20160805properSubjFieldsProperColNames.csv')
xcp <- read.csv('/data/joy/BBL/projects/grmpyProcessing2017/structural/OutputROI/JLFvol/jlfVolValues_20160805properSubjFieldsProperColNames.csv')
b0 <- read.csv('/data/joy/BBL/projects/grmpyProcessing2017/structural/OutputROI/JLFvol/voxelVolume_20160805properSubjFields.csv')
coverage <- read.csv('/data/joy/BBL/projects/grmpyProcessing2017/structural/OutputROI/JLFvol/n115_T1ManualQA_20170724.csv')
data0 <- merge(data,xcp,by='subject.0.',all.x=T)
data1 <- merge(data0,b0,by='subject.0.',all.x=T)
data2 <- merge(data1,coverage,by='subject.0.',all.x=T)
